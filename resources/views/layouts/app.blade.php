...
<head>
    ...
    <link rel="icon" type="image/jpg" sizes="16x16" href="photo.jpg">
    <title>IENA</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo icon--><img src="photo.jpg" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="photo.jpg" width='50' alt="home" class="light-logo" />
                    </b>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                @switch(Auth::user()->tipo_id)
                    @case(USER_TIPO_LIDER)
                        @component('components.sidebarLider')
                        @endcomponent
                        @break;
                    @case(USER_TIPO_SUPERVISOR)
                        @component('components.sidebarSupervisor')
                        @endcomponent
                        @break
                    @case(USER_TIPO_PASTOR)
                        @component('components.sidebarPastor')
                        @endcomponent
                        @break
                @endswitch
